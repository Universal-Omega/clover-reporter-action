...
##### `clover-base` (**Optional**)
The location of the clover file resulting from running the tests in the base
...
```yml
uses: Universal-Omega/clover-reporter-action@main
with:
